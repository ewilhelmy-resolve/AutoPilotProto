	...
	return (
		<>
			...
			<div className="fixed inset-y-0 right-0 left-0 z-0 flex flex-col overflow-hidden">
				<header className={`h-[67px] bg-background flex items-center flex-shrink-0 pr-6 border-b border-gray-200 transition-[padding] duration-200 ease-linear ${state === "expanded" ? "lg:pl-48" : "lg:pl-12"}`}>
				...
				<div className={`flex flex-1 overflow-hidden min-w-0 transition-[padding] duration-200 ease-linear ${state === "expanded" ? "lg:pl-48" : "lg:pl-12"}`}>
